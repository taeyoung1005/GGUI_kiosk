...
| 명령 | 설명 |
|---|---|
| `npm run setup` | 루트와 B/C/D Node 의존성 설치, Module A Python venv 구성 |
...
| `bash run.sh stop` | 8000/8001/8002/5173/6781 포트 정리 |
...
`voice-adaptive-kiosk/.env.example`을 복사해 `voice-adaptive-kiosk/.env` 하나로 관리합니다.
